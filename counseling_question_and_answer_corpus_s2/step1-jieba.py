...
# 读取文本
df = pd.read_csv(r"C:\Users\dell\Desktop\毕设\数据分析\语料库数据分析\step1\source.csv",engine = 'python').astype(str)
...
print(test) 
test.to_csv(r"C:\Users\dell\Desktop\毕设\数据分析\语料库数据分析\step1\resultt.csv",encoding='ANSI')
